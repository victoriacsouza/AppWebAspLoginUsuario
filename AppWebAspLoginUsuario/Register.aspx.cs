...
namespace AppWebAspLoginUsuario
{
    public partial class Register : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            con.ConnectionString = "Data Source=36DE250020\\SENAC;Initial Catalog=login;Integrated Security=True";
            /* Abertura da Conexão */
            con.Open();
        ...
        {
            if (confEmail.Text != txbEmail.Text)
            {
                Response.Write("<script> alert('Os emails digtados são diferentes.');</script>");
            }
            else
            {
            ...
            cmd.CommandText = "INSERT INTO users(email, pass, nome, sobrenome)VALUES('" + txbEmail.Text.ToString() + "', '" + txbPass.Text.ToString() + "', '" + txbNome.Text.ToString() + "', '" + txbSobreNome.Text.ToString() + "' );"; 
          ...
          //  dataShowUser();
            ...
            txbEmail.Text = txbPass.Text = txbNome.Text = txbSobreNome.Text = String.Empty;
